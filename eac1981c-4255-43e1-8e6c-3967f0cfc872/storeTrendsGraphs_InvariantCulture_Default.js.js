   ...
   var chartFieldsArray =
      {
         ...
         OsInstallBase:
         {
            PC: [
               {
                  field: "WindowsSPSEVEN",
                  name: "Windows 7"
               },
               {
                  field: "WindowsSPEIGHT",
                  name: "Windows 8"
               },
               {
                  field: "WindowsSPONEZERO",
                  name: "Windows 10"
               }],
            Phone: [
               {
   ...
   var processCultureData = function () {
      ...
      chartFieldsArray[trendTypeDownloadCategoryAppsString] = [
         ...
         },
         {
            ...
            name: cultureJSONData[currentLocale]["Photo & video"]
         },
         {
            field: "Productivity",
         ...
         },
         {
            ...
            name: cultureJSONData[currentLocale]["Utilities & tools"]
         },
         {
            field: "Video",
            name: "Video"
